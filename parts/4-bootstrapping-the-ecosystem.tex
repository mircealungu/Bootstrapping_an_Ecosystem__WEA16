...
\begin{enumerate}
	...
	\item An initial version of the learning accelerator platform, containing the Historian, a Translator that relies on external services, and a very basic version of the Oracle, exposed via a REST API. \cite{Lung16zeeguu}. 
